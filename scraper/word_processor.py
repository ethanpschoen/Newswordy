...
class WordProcessor:
    ...
    def __init__(self):
        ...
        self.news_words = {
            ...
            'president', 'minister', 'spokesperson', 'announced', 'announcement',
            'statement', 'comment', 'comments', 'response', 'responded', 'saying',
            'told', 'tells', 'telling', 'speaking', 'spoke', 'address', 'addressed',
            'meeting', 'meet', 'met', 'conference', 'press', 'media', 'journalist',
            'reporter', 'coverage', 'covered', 'covering', 'investigation', 'investigating',
            'investigated', 'probe', 'probes', 'probed', 'alleged', 'allegedly',
            'accused', 'accusing', 'charges', 'charged', 'charging', 'arrested',
            'arrest', 'arresting', 'trial', 'court', 'judge', 'judgment', 'ruling',
            'ruled', 'rules', 'law', 'legal', 'illegal', 'crime', 'criminal',
            'victim', 'victims', 'killed', 'killing', 'death', 'dead', 'died',
            'injured', 'injury', 'injuries', 'hospital', 'hospitalized', 'medical',
            'health', 'healthcare', 'doctor', 'doctors', 'patient', 'patients',
            'disease', 'virus', 'infection', 'outbreak', 'pandemic', 'epidemic',
            'vaccine', 'vaccination', 'vaccinated', 'testing', 'tested', 'tests',
            'positive', 'negative', 'cases', 'case', 'confirmed', 'confirmation',
            'suspected', 'suspicion', 'investigation', 'investigating', 'investigated',
            'probe', 'probes', 'probed', 'alleged', 'allegedly', 'accused', 'accusing',
            'charges', 'charged', 'charging', 'arrested', 'arrest', 'arresting',
            'trial', 'court', 'judge', 'judgment', 'ruling', 'ruled', 'rules',
            'law', 'legal', 'illegal', 'crime', 'criminal', 'victim', 'victims',
            'killed', 'killing', 'death', 'dead', 'died', 'injured', 'injury',
            'injuries', 'hospital', 'hospitalized', 'medical', 'health', 'healthcare',
            'doctor', 'doctors', 'patient', 'patients', 'disease', 'virus',
            'infection', 'outbreak', 'pandemic', 'epidemic', 'vaccine', 'vaccination',
            'vaccinated', 'testing', 'tested', 'tests', 'positive', 'negative',
            'cases', 'case', 'confirmed', 'confirmation', 'suspected', 'suspicion'
        }
