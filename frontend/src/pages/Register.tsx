...
const Register: React.FC = () => {
  ...
  const handleSignup = () => {
    // Auth0 handles both login and signup through the same flow
    // Users can choose to sign up or log in on the Auth0 universal login page
    login()
  }
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Create your account to start playing the word game
          </p>
        </div>
