import { Box, Card, CardContent, IconButton, Paper, Stack, Typography, Drawer, useMediaQuery, useTheme } from "@mui/material"
import {
...
const ArticleInfo = ({
	...
	if (isMobile) {
		return (
			...
			>
				<Box sx={{ p: 2, pb: 3, height: '100%', display: 'flex', flexDirection: 'column' }}>
					{articleContent}
				</Box>
			</Drawer>
		)
