    ...
    <Card sx={{ minHeight: isMobile ? 'auto' : '340px' }}>
			<CardContent sx={{ py: 2 }}>
				...
				<Stack direction={isMobile ? 'row' : 'column'} spacing={isMobile ? 1 : 1.5} sx={isMobile ? { gap: 1 } : {}}>
					...
					>
						<Typography variant={isMobile ? "body1" : "h6"} component="div" sx={{ fontWeight: 'bold', color: 'primary.main', mb: 0.5 }}>
							{score}
						</Typography>
					...
					>
						<Typography variant={isMobile ? "body1" : "h6"} component="div" sx={{ fontWeight: 'bold', color: 'success.main', mb: 0.5 }}>
							{guessedWords.length}
						</Typography>
					...
					>
						<Typography variant={isMobile ? "body1" : "h6"} component="div" sx={{ fontWeight: 'bold', color: 'secondary.main', mb: 0.5 }}>
							{remainingGuesses}
						</Typography>
