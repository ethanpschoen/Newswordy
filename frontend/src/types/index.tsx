...
export const NewsSourceConfig: Record<NewsSource, { name: string; logoSrc: string }> = {
  ...
  [NewsSource.NEW_YORK_TIMES]: { name: 'The New York Times', logoSrc: NYTimesLogo },
...
export const COMPARE_PRESETS: ComparePreset[] = [
  {
    ...
    groupASources: [NewsSource.NEW_YORK_TIMES, NewsSource.GUARDIAN, NewsSource.NPR, NewsSource.WASHINGTON_POST],
